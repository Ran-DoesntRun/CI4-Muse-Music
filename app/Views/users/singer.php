...
<div class=" max-w-screen-xl mx-auto flex flex-col mt-5">
  <div class="flex flex-col md:flex-row shadow py-3 bg-gray-200 mb-5">
    <img src="<?= base_url() ?>assets/images/<?= $img; ?>" alt="Twice This Is For" class="my-auto size-55 mx-auto md:ml-5 md:mr-0">
      <div class="flex flex-col ml-3">
        ...
        <h3><span class=" font-bold"><?= $singer_type; ?></span></h3>
        <?php 
        if($singer_type != 'Soloist'){
          ?>
          <p>Members : <?= $members; ?></p>
        <?php }  ?>
        <p>Debut : <?= $debut; ?></p>
  ...
  <div class="flex flex-col shadow py-3 bg-gray-200 mb-5">
    <h2 class="ml-5 text-lg font-bold">ABOUT <?= $title; ?></h2>
    <p class="ml-5"><?= $bio; ?></p>
  </div>
  <div class="w-full max-w-screen-xl flex flex-col bg-gray-200 mt-4 mx-auto space-y-2 pb-5">
