...
<div class=" max-w-screen-xl mx-auto flex flex-col mt-5">
  ...
  <div class="shadow pb-4 mb-5 bg-gray-100 px-5 pt-4 rounded-lg <?php if (!session()->has('email')) { echo 'hidden'; } ?>">
    ...
    <form action="<?= base_url(); ?>song/comment/<?= $id; ?>" method="post" class="space-y-3">
      ...
      <div class="text-right">
        <button type="submit" class="bg-purple-600 hover:bg-purple-700 text-white px-5 py-2 rounded-lg">Post Comment</button>
      </div>
    </form>
  </div>
  ...
  <div class="shadow pb-4">
    ...
    foreach($comments as $cmnt) { ?>
      <div class="flex flex-col mt-4 ml-5 pl-3 pb-3 shadow bg-gray-50 mr-5 rounded">
